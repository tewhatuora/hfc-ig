Instance: gender-to-r4
InstanceOf: ConceptMap
Usage: #definition
* url = "https://nzhts.digital.health.nz/fhir/ConceptMap/gender-to-r4"
* version = "1.0"
